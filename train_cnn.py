...
from tensorflow.keras.layers import BatchNormalization, MaxPooling2D, LeakyReLU, Flatten, Conv2D, Dense, Input
...
if (__name__ == "__main__"):
    history_name : str = "/content/drive/MyDrive/multimedia_hw4_train_history/cnn/{}.json".format(datetime.now().strftime("%Y%m%d_%H%M%S"))
